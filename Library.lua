...
finity.dark_theme = { -- dark
	main_container = Color3.fromRGB(17, 17, 17),
	separator_color = Color3.fromRGB(45, 45, 46),

	text_color = Color3.fromRGB(206, 206, 206),

	category_button_background = Color3.fromRGB(45, 45, 46),
	category_button_border = Color3.fromRGB(45, 45, 46),

	checkbox_checked = Color3.fromRGB(87, 92, 255),
	checkbox_outer = Color3.fromRGB(84, 81, 86),
	checkbox_inner = Color3.fromRGB(132, 132, 136),

	slider_color = Color3.fromRGB(177, 177, 177),
	slider_color_sliding = Color3.fromRGB(87, 92, 255),
